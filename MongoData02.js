...
.factory('presidents', function($resource) {
	...
	var Prog270 = $resource('https://api.mongolab.com/api/1/databases/Prog270/collections/Widgets/:id', {
      // apiKey:'4fb51e55e4b02e56a67b0b66',
      apiKey:'mVioK7RiTicJ2u1wTH2OS9qxgspvQ8Es',
      id:'@_id.$oid'
    });

    Prog270.prototype.getfirstName = function() {
      return this.firstName;
    };
    
   Prog270.prototype.getlastName = function() {
